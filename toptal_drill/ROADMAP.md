...
| 08 | Continuous Subarrays | 75% | Med | ⬜ *(new tool: monotonic deque — warm-up foundations/11 ready)* |
...
- _(none — all cleared; #7 solved + cold-redone same day 2026-08-13)_

## 🗓️ Run-up to Toptal (round: Tue 2026-08-18, evening)
| Day | Plan |
|-----|------|
| Fri 08-14 | foundations/11 deque warm-up → drill #8 Continuous Subarrays |
